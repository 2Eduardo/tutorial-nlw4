...
interface FeedbackSuccessProps {
  onFeedbackSuccessFallback: () => void;
}

export function FeedbackSuccess({ onFeedbackSuccessFallback }: FeedbackSuccessProps) {
  return (
    <>
      <header>
        <CloseButton />
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <button
          type="button"
          onClick={onFeedbackSuccessFallback}
          className="py-2 px-2 mt-6 bg-zinc-800 rounded-md border-transparent text-sm 
        leading-6 hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2
